...
def main():
    ...
    solver = Solver(from_date, to_date, employees, employees_senior, max_h_employee_for_day, min_h_employee_for_day, ob_weight, weekend_pattern_const)
    '''
    ...
    '''
    status = solver.solve(timeLimit=60, gapRel = 0.05, threads=4)
